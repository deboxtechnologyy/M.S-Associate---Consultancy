    ...
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="bg-white min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-8 py-12">
          ...
          >
            ...
            >
              Civil &amp; Corporate Law Division · Litigation Experts
            </p>
          </div>
          ...
          >
            Resolving disputes efficiently through expert legal guidance in contracts, property, debt recovery, and civil matters.
          </p>
        </div>
      </div>
      ...
      <div style={{ background: "#f8f9fc", borderBottom: "1px solid #e8edf4" }}>
        ...
        >
          ...
          <span style={{ color: "#b8860b", fontWeight: 600 }}>Civil &amp; Corporate Law Division</span>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <section id="introduction">
            ...
            >
              ...
              >
                ...
                >
                  Civil disputes can affect your business, property, and financial interests. At{" "}
                  <strong style={{ color: "#172e4e" }}>M.S Associates &amp; Consultancy</strong>
                  , we provide strategic legal guidance to protect your rights and achieve favorable outcomes in civil litigation.
                </p>
                ...
                <p
                  ...
                  style={{ color: "#374151", fontSize: "clamp(0.85rem, 2vw, 0.95rem)", fontWeight: 400, lineHeight: "1.85" }}
                >
                  From contract enforcement to property disputes, debt recovery, and corporate matters, our team handles all civil suits with diligence, precision, and professionalism.
                </p>
              </div>
            </div>
            <div
          ...
          <section id="grounds">
            <SectionHeading>Types of Civil Cases We Handle</SectionHeading>
            <p
              className="mb-6 sm:mb-8 ml-0 sm:ml-14"
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              Comprehensive legal solutions for property, contract, debt recovery, and other civil disputes.
            </p>
            <div
          ...
          <section id="services">
            ...
            <p
              ...
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              Expert legal support for civil suits across property, contracts, corporate disputes, and debt recovery.
            </p>
            <div
              className="grid gap-4 sm:gap-5"
          ...
          <section id="why-choose-us">
            ...
            >
              <div className="relative px-6 sm:px-8 md:px-12 pt-8 sm:pt-10 pb-5 sm:pb-6 text-center overflow-hidden">
                ...
                >
                  Experienced civil litigators ensuring timely, precise, and results-driven representation.
                </p>
              </div>
              <div
                style={{
          ...
          <section id="cta">
            ...
            >
              ...
              <div className="relative z-10 p-6 sm:p-8 md:p-14 text-center">
                ...
                >
                  Resolve Your Civil<br />
                  <span style={{ color: "#92740a" }}>Disputes Effectively</span>
                </h2>
                <p
                  className="text-sm max-w-md mx-auto mb-6 sm:mb-8"
                  style={{ color: "#4b5563", fontWeight: 400, lineHeight: "1.8" }}
                >
                  Facing property, contract, or debt recovery issues? Contact our legal team for expert guidance and representation.
                </p>
