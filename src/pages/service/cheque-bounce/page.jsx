  ...
  useEffect(() => {
    ...
    style.textContent = `
      * { box-sizing: border-box; }
      ...
      /* Hide sidebar, show float btn below lg */
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="bg-white min-h-screen">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://i.pinimg.com/736x/c1/c5/2d/c1c52d371dad512cb894cb12499f107d.jpg')",
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-8 py-12">
          ...
          >
            ...
            >
              Banking &amp; Financial Law Division · Expert Legal Support
            </p>
          </div>
          ...
          >
            Protect your financial interests with timely, strategic, and reliable legal intervention for dishonoured cheques.
          </p>
      ...
      >
        ...
        >
          ...
          <section id="introduction">
            ...
            >
              ...
              >
                ...
                >
                  Dishonoured cheques under Section 138 of the Negotiable Instruments Act require swift and precise legal action. At{" "}
                  <strong style={{ color: "#172e4e" }}>M.S Associates &amp; Consultants</strong>
                  , we guide clients through all legal proceedings to recover dues or defend allegations.
                </p>
                ...
                <p
                  ...
                  style={{ color: "#374151", fontSize: "clamp(0.85rem, 2vw, 0.95rem)", fontWeight: 400, lineHeight: "1.85" }}
                >
                  We handle cheque bounce complaints, anticipatory protection, and related litigation in civil and criminal courts.
                  Our approach ensures timely notice drafting, strategic representation, and maximum protection of your interests.
                </p>
              </div>
            </div>
            <div
          ...
          {/* TYPES OF CASES */}
          <section id="grounds">
            <SectionHeading>Types of Cases We Handle</SectionHeading>
            <p
              className="mb-6 sm:mb-8 ml-0 sm:ml-14"
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              Complete legal coverage for cheque dishonour matters under Section 138 of NI Act.
            </p>
            <div
          ...
          <section id="services">
            ...
            <p
              ...
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              Expert legal support for Section 138 &amp; cheque dishonour cases across civil and criminal jurisdictions.
            </p>
            <div
              className="grid gap-4 sm:gap-5"
          ...
          <section id="why-choose-us">
            ...
            >
              <div className="relative px-6 sm:px-8 md:px-12 pt-8 sm:pt-10 pb-5 sm:pb-6 text-center overflow-hidden">
                ...
                >
                  Expertise in banking law combined with timely action ensures faster relief and client satisfaction.
                </p>
              </div>
              <div
                style={{
          ...
          <section id="cta">
            ...
            >
              ...
              <div className="relative z-10 p-6 sm:p-8 md:p-14 text-center">
                ...
                >
                  Protect Your Financial Rights<br />
                  <span style={{ color: "#92740a" }}>Act Promptly</span>
                </h2>
                <p
                  className="text-sm max-w-md mx-auto mb-6 sm:mb-8"
                  style={{ color: "#4b5563", fontWeight: 400, lineHeight: "1.8" }}
                >
                  If a cheque has bounced or you are facing a Section 138 complaint, contact our legal team immediately for expert guidance and representation.
                </p>
                <div
                  className="cta-buttons flex gap-3 justify-center flex-wrap"
                >
                  <button
