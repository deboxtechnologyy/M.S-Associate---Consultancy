    ...
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="bg-white min-h-screen">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/7876053/pexels-photo-7876053.jpeg')",
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-8 py-12">
          ...
          >
            ...
            >
              Family Law Division · Divorce &amp; Matrimonial Experts
            </p>
          </div>
          ...
          >
            Guiding you through life's most challenging transitions with clarity, compassion, and unwavering legal strength.
          </p>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  , we provide compassionate, strategic guidance to protect your rights, family, and future.
                </p>
                ...
                <p
                  ...
                  style={{ color: "#374151", fontSize: "clamp(0.85rem, 2vw, 0.95rem)", fontWeight: 400, lineHeight: "1.85" }}
                >
                  We handle matters including mutual consent divorce, contested divorce, child custody, maintenance, and domestic violence cases with care, expertise, and dedication.
                </p>
              </div>
            </div>
            <div
