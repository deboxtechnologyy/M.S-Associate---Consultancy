    ...
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="bg-white min-h-screen">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/34817075/pexels-photo-34817075.jpeg')",
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-8 py-12">
          ...
          >
            ...
            >
              Criminal Law Division · Defense &amp; Prosecution Experts
            </p>
          </div>
          ...
          >
            Protecting your rights and freedom with expert defense and representation in criminal matters.
          </p>
      ...
      <div style={{ background: "#f8f9fc", borderBottom: "1px solid #e8edf4" }}>
        ...
        >
          ...
          <span style={{ color: "#aab4c0" }}>›</span>
          <span style={{ color: "#b8860b", fontWeight: 600 }}>Criminal Cases &amp; Litigation</span>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <section id="introduction">
            ...
            >
              ...
              >
                ...
                >
                  Criminal cases demand urgent attention, expert knowledge, and strategic representation. At{" "}
                  <strong style={{ color: "#172e4e" }}>M.S Associates &amp; Consultancy</strong>
                  , we provide skilled defense and prosecution services to safeguard your rights, reputation, and liberty.
                </p>
                ...
                <p
                  ...
                  style={{ color: "#374151", fontSize: "clamp(0.85rem, 2vw, 0.95rem)", fontWeight: 400, lineHeight: "1.85" }}
                >
                  Our team handles a wide range of criminal matters including white-collar crimes, property offenses, cybercrime, and serious criminal allegations in courts across India.
                </p>
              </div>
            </div>
            <div
          ...
          <section id="grounds">
            <SectionHeading>Types of Criminal Cases We Handle</SectionHeading>
            <p
              className="mb-6 sm:mb-8 ml-0 sm:ml-14"
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              Comprehensive criminal law services for defense and prosecution across all legal levels.
            </p>
            <div
          ...
          <section id="services">
            ...
            <p
              ...
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              End-to-end criminal law services, from investigation to court representation and appellate proceedings.
            </p>
            <div
              className="grid gap-4 sm:gap-5"
          ...
          <section id="cta">
            ...
            >
              ...
              <div className="relative z-10 p-6 sm:p-8 md:p-14 text-center">
                ...
                >
                  Facing criminal charges or need expert legal representation? Our team provides prompt, professional, and effective assistance.
                </p>
