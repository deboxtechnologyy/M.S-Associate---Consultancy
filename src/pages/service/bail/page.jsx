    ...
    style.textContent = `
      * { box-sizing: border-box; }
      ...
      @media (max-width: 767px) {
        .hero-badge-text { font-size: 0.65rem !important; letter-spacing: 0.08em !important; }
        ...
        .why-title { font-size: 1.5rem !important; }
  ...
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="bg-white min-h-screen">
      ...
      >
        ...
        {/* Geometric decorations — hidden on very small screens for clarity */}
        <div
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-8 py-12">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#d39f17", fontWeight: 500, letterSpacing: "0.12em", fontSize: "0.7rem", textTransform: "uppercase" }}
            >
              Criminal Law Division · Immediate Legal Assistance
            </p>
          </div>

          <h1
            className="fade-up delay-2 hero-title text-white"
            style={{
          ...
          <p
            className="fade-up delay-3 hero-subtitle mt-4 sm:mt-5 max-w-xl"
            style={{ color: "#bdd4f0", fontWeight: 300, lineHeight: "1.85", fontSize: "clamp(0.78rem, 2vw, 0.95rem)" }}
          >
            Providing swift, strategic, and reliable legal representation{" "}
            when your freedom and reputation are at stake.
          </p>
      ...
      >
        {/* Sidebar — hidden on mobile/tablet via CSS, shown lg+; sticky on desktop */}
        <div
        ...
        >
          ...
          <section id="introduction">
            ...
            >
              ...
              >
                ...
                >
                  Bail matters require urgent and strategic legal action. At{" "}
                  <strong style={{ color: "#172e4e" }}>M.S &amp; Associates &amp; Legal Consultancy</strong>
                  , we understand that arrest or criminal allegations can be overwhelming.
                  Our experienced criminal defense team works swiftly to protect your liberty and legal rights.
                </p>
                ...
                <p
                  ...
                  style={{ color: "#374151", fontSize: "clamp(0.85rem, 2vw, 0.95rem)", fontWeight: 400, lineHeight: "1.85" }}
                >
                  We handle regular bail, anticipatory bail, interim bail, and bail cancellation matters.
                  Our approach combines thorough preparation, precise drafting, and persuasive courtroom advocacy
                  to secure relief at the earliest possible stage.
                </p>
              </div>
            </div>
            <div
              className="stat-grid grid gap-3 sm:gap-4"
          ...
          {/* TYPES OF BAIL */}
          <section id="grounds">
            <SectionHeading>Types of Bail We Handle</SectionHeading>
            <p
              className="mb-6 sm:mb-8 ml-0 sm:ml-14"
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              Comprehensive representation across all categories of bail applications under Indian law.
            </p>
            <div
          ...
          <section id="services">
            ...
            <p
              ...
              style={{ color: "#6b7280", fontSize: "0.875rem", fontWeight: 400, marginTop: "-8px" }}
            >
              Strategic defense and urgent legal intervention at every stage of criminal proceedings.
            </p>
            <div
              className="grid gap-4 sm:gap-5"
          ...
          <section id="why-choose-us">
            ...
            >
              <div className="relative px-6 sm:px-8 md:px-12 pt-8 sm:pt-10 pb-5 sm:pb-6 text-center overflow-hidden">
                ...
                <h2
                  className="text-white relative why-title"
                  style={{
                    fontFamily: "'Playfair Display', serif",
                    fontWeight: 700,
                ...
                >
                  When liberty is at stake, experience and speed make the difference.
                </p>
              </div>
              <div
                style={{
            ...
            >
              ...
              <div className="relative z-10 p-6 sm:p-8 md:p-14 text-center">
                ...
                >
                  ...
                  >
                    Urgent Legal Assistance Available
                  </span>
                </div>
                <h2
                  className="mb-4 cta-title"
                  style={{
                    fontFamily: "'Playfair Display', serif",
                    color: "#172e4e",
                    fontWeight: 700,
                ...
                >
                  Protect Your Freedom <br />
                  <span style={{ color: "#92740a" }}>Act Without Delay</span>
                </h2>
                <p
                  className="text-sm max-w-md mx-auto mb-6 sm:mb-8"
                  style={{ color: "#4b5563", fontWeight: 400, lineHeight: "1.8" }}
                >
                  If you or a loved one requires immediate bail assistance, contact our legal team now.
                  Early legal intervention significantly improves the chances of relief.
                </p>
                <div
                  className="cta-buttons flex gap-3 justify-center"
                  style={{ flexWrap: "wrap" }}
                >
                  <button
