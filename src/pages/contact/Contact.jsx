      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media (max-width: 600px) {
          .hero-grid { gap: 28px; }
          .hero-areas-grid { grid-template-columns: 1fr 1fr; gap: 8px; }
        ...
        @media (max-width: 380px) {
          .hero-areas-grid { grid-template-columns: 1fr; }
              ...
              <div>
                ...
                <div className="hero-stats">
                  {[["5,000+", "Cases Handled"], ["30+", "Years Practice"], ["98%", "Satisfaction"]].map(([n, l]) => (
                    <div key={l}>
                      <div className="pf" style={{ fontSize: "clamp(20px, 2.5vw, 26px)", fontWeight: 700, color: G, lineHeight: 1 }}>{n}</div>
                ...
                <div className="hero-areas-grid">
                  {["Criminal Defence", "Family & Divorce", "Property Law", "Corporate Matters", "Civil Litigation", "Constitutional Law", "Bail Applications", "Labour Law"].map(a => (
                    <div key={a} style={{ padding: "10px 14px", background: "rgba(255,255,255,0.05)", borderRadius: 8, border: "1px solid rgba(255,255,255,0.07)" }}>
                      <span className="pp" style={{ fontSize: "clamp(11px, 1.2vw, 12.5px)", color: "rgba(255,255,255,0.7)", fontWeight: 400 }}>{a}</span>
                    </div>
                  ))}
                </div>
        ...
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          ...
          <div className="form-grid">
            ...
            <div {...reveal("fp", 0.12)} style={{ ...reveal("fp", 0.12).style }}>
              <div style={{ background: P, borderRadius: 18, overflow: "hidden", position: "relative", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "40px 36px", minHeight: 460 }}>
                ...
                <div style={{ position: "relative", zIndex: 1, marginTop: 36, paddingTop: 24, borderTop: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <div className="pf" style={{ fontSize: "clamp(14px, 1.8vw, 17px)", fontWeight: 700, color: G }}>+91 98100 00000</div>
                  </div>
                </div>
              </div>
            </div>
